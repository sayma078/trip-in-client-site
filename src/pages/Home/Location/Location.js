    ...
    return (
        ...
        <div className="mt-5 row  d-flex justify-content-center">
          <div className="card-body col-md-3 ">
            <h2>
              <i className="fas fa-phone-volume text-info"></i>
            </h2>
            <h3 className="text-info">Emergency Phone</h3>
          ...
          <div className="card-body col-md-3">
            <h2>
              <i className="fas fa-phone-square-alt text-info"></i>
            </h2>
            <h3 className="text-info">Book By Phone</h3>
          ...
          <div className="card-body col-md-3">
            ...
            <h3 className="text-info">Email Us</h3>
            <p className="card-text">
